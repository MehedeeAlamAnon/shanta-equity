          ...
          <main class="main mega-menu-main text-white" v-if="elementVisible">
            <div class="main-top d-flex">
              <aside class="sidebar sidebar-left">
                <p class="sidebar-text">
                  Shanta Securities Limited is an innovative financial services
                  company offering a range of brokerage and investing solutions.
                </p>
                <p class="sidebar-text">
                  We believe in being committed to going the extra mile for our
                  customers and using our intuitive research to help clients
              ...
              <div class="main-content">
                <div class="mega-menu-list">
                  ...
                  >
                    <NuxtLink
                      class="mega-menu-item-link"
                      to="/research-investment/ipo-review"
                    >
                      <h5 class="mega-menu-item-title mb-3 text-white">
                        Research & Investment
                      </h5>
                      ...
                      >
                        ...
                        >
                        <NuxtLink
                          to="/research-investment/daily-market-recap"
                          class="mega-menu-nested-link"
                          >Daily Market Recap,</NuxtLink
                        >
                        <NuxtLink
                          to="/research-investment/morning-news-flash"
                          class="mega-menu-nested-link"
            ...
            <footer class="footer d-flex align-items-center">
              ...
              <div class="footer-menu d-flex justify-content-start">
                ...
                <NuxtLink
                  to="/news-updates/stock-exchange-news"
